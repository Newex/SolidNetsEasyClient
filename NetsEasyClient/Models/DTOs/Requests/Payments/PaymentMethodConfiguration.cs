...
{
    /// <summary>
    /// The name of the payment method or payment type to be configured, if the
    ...
    /// specified alongside payment methods that belong to it, if it happens the
    ...
    /// <summary>
    /// Indicates that the specified payment method/type is allowed to be used
    /// for this payment, defaults to true. If one or more payment method/type
    /// is configured in the parent array then this value will be considered
